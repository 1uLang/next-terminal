...
func (r credentialRepository) List(c context.Context, pageIndex, pageSize int, name, order, field string, ids []string) (o []model.CredentialForPage, total int64, err error) {
